...
class UpdateNotificationCriteriaScreen extends StatefulWidget {
  final String title;
  final String message;
  final String links;

  const UpdateNotificationCriteriaScreen({
    super.key,
    required this.title,
  ...
  @override
  State<UpdateNotificationCriteriaScreen> createState() =>
      _UpdateNotificationCriteriaScreenState();
}

class _UpdateNotificationCriteriaScreenState
    extends State<UpdateNotificationCriteriaScreen> {
